...
On retrouve par exemple des débuts et des fins de phrases fusionnées (ex: "Zoom
...
On regardant les lemmatisation proposées, nous avons conclus que lexique382
était la meilleure base que nous avions, puis hash_lemma_fr et la base trouvée
sur GitHub. Nous avons donc réalisé une fonction pour fusionner en prenant en
compte cet ordre de priorité
