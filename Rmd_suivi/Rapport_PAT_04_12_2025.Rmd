...
txt <- tolower(str_replace_all(string=txt, villes_filtre,""))  # application du villes des filtres des villes: retire les noms de villes + passe le texte en minuscules pour la suite
...
- hash_lemmar_fr qui provient du package lemmar 
- lexique382 qui provient du package mixr 
- une liste obtenue sur un le GitHub de l'utilisateur michmech : <https://github.com/michmech/lemmatization-lists/tree/master>
