...
Il y a t-il un lien entre les ‘descriptions_des_enjeux_par_le_porteur’
et les ‘objectifs_strategiques’ ? Peut-on associer ces descriptions aux
objectifs en faisant du matching de texte ? (correspondance entre enjeux
et obj en %)

# Objectif stratégiques des PAT

Est-il intéressant de garder les 5 colonnes de ‘objectifs_strategiques’
? Comment la réponse a cette question est-elle interprétée
(différemment?) par les porteurs de projet? Certains porteurs ont tout
mis dans la 1e colonnes, tous les PAT n’ont pas le même nombre
d’objectifs (3, 4, 5, 6 ….)
...
Il y a t-il un ordonnancement des objectifs stratégiques de 1 à 5, du
plus vers le moins important ?
...
“Pour les PAT candidats au niveau 2, il y a selon les directives du
ministère de l'Agriculture et de la Souveraineté Alimentaire[6], les
candidats doivent élaborer une feuille de route annexée au pland'actions
du PAT, s'engageant à suivre au moins un indicateur d’évaluation pour
chaque thématique de la Stratégie Nationale Alimentation, Nutrition et
Climat (SNANC) et à fixer un objectif quantitatif par indicateur
sélectionné.

=\> ces indicateurs ne sont pas obligatoirement définis dans la
catégorie “mesures d’évaluation” ce qui rend difficile la comparaison
des PAT entre eux =\> pas d’accès à leurs objectifs et la quantification
(résultats du PAT)

C'est une faiblesse importante de la base.

On peut cependant utiliser les "resultats atteints" et "resultats
attendus" de chaque action.
