...
df.zerorep <- data.frame(t(apply(df.zerorep,1,function(x) (x/sum(x))*100)))
...
res.ca <- FactoMineR::CA(df.ca, ncp = 2)
...
Les PAT les plus purs des 6 topics se retrouvent ils dans les clusters surreprésentant leurs 
